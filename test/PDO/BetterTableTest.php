...
use CeusMedia\Database\PDO\BetterTable as PdoTable;
 ...
 *	@author			Christian Würker <christian.wuerker@ceusmedia.de>
 */
class BetterTableTest extends TestCase
{
	...
	public function testGetField(): void
	{
		...
		$data	= $this->table->getField( 2, 'label' );
	...
	public function testGetFirstFieldByIndex(): void
	{
		$this->table->remove( 1 );
		$this->table->add( ['topic' => 'start', 'label' => 'label1'] );
		$this->table->add( ['topic' => 'start', 'label' => 'label2'] );
		...
		$orders		= ['label' => 'DESC'];
		$field		= 'label';
		$result		= $this->table->getFirstFieldByIndex( $field, 'topic', 'start', $orders );
		self::assertEquals( 'label2', $result );
	}

	public function testGetFirstFieldsByIndex(): void
	{
		$this->table->remove( 1 );
		$this->table->add( ['topic' => 'start', 'label' => 'label1'] );
		$this->table->add( ['topic' => 'start', 'label' => 'label2'] );
		...
		$orders		= ['label' => 'DESC'];
		$fields		= ['label', 'topic'];
		$result		= $this->table->getFirstFieldsByIndex( $fields, 'topic', 'start', $orders );
	...
	public function testGetFirstByIndices(): void
	{
		$this->table->remove( 1 );
		$this->table->add( ['topic' => 'start', 'label' => 'label1'] );
		$this->table->add( ['topic' => 'start', 'label' => 'label2'] );
		...
		$orders		= ['label' => 'DESC'];
		$field		= 'label';
		$result		= $this->table->getFirstFieldByIndices( $field, $indices, $orders );
		self::assertEquals( 'label2', $result );
	}

	public function testGetFirstFieldsByIndices(): void
	{
		$this->table->remove( 1 );
		$this->table->add( ['topic' => 'start', 'label' => 'label1'] );
		$this->table->add( ['topic' => 'start', 'label' => 'label2'] );
		...
		$fields		= ['label', 'topic'];
		$orders		= ['label' => 'DESC'];
		$result		= $this->table->getFirstFieldsByIndices( $fields, $indices, $orders );
	...
	protected function setUp(): void
	{
		...
		$this->table	= new BetterTransactionTable( $this->connection );
	}
